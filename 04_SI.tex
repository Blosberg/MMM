...
Spoiled, and minor-party 2nd ballots should default towards the pre-existing results from the first ballot (i.e., the current FPP system), and serve to inhibit supplementary MPs altogether. 
