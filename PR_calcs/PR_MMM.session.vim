...
set laststatus=2
set modelines=0
set runtimepath=~/.vim,~/.vim/pack/packages/start/nerdtree-git-plugin,~/.vim/pack/packages/start/nerdtree,~/.vim/pack/packages/start/lightline,~/.vim/pack/packages/start/gundo,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,~/.vim/after
set splitbelow
set splitright
...
silent only
cd ~/Desktop/personal_projects/MMM/PR_calcs
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 PR_Osberg.cpp
badd +4 raw_results_2011.txt
badd +1 PR_Osberg_funcs.cpp
badd +2 ~/.vim/foldstyles.vim
argglobal
silent! argdel *
$argadd PR_Osberg.cpp
edit PR_Osberg.cpp
...
271
normal! zo
let s:l = 228 - ((22 * winheight(0) + 26) / 52)
...
wincmd w
argglobal
if bufexists('PR_Osberg_funcs.cpp') | buffer PR_Osberg_funcs.cpp | else | edit PR_Osberg_funcs.cpp | endif
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
18
normal! zo
let s:l = 40 - ((23 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
